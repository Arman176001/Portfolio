export const navItems = [
  ...
  export const gridItems = [
    ...
    {
      id: 5,
      title: "Currently building AI for ARC-AGI",
  ...
  export const projects = [
    {
      id: 1,
      title: "Researching Tool powered by AI",
      des: "Get the prescice result according to your Proofession according to your needs",
      img: "/ResearchAI.png",
